...
This QR code component is designed to be easily integrated into your React projects, providing a visually appealing way to display QR codes. The component is responsive and customizable, making it suitable for various projects.
...
- Integrated the 'Outfit' font from Google Fonts to enhance the typography of the project.
